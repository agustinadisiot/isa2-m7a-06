...
namespace MinTur.DataAccess.Migrations
{
    ...
    [Migration("20201007002436_TotalPriceOnReservationColumn")]
    partial class TotalPriceOnReservationColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BusinessEntities.Administrator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.BusinessEntities.AuthorizationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.BusinessEntities.ReservationState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.BusinessEntities.AuthorizationToken", b =>
                {
                    b.HasOne("Domain.BusinessEntities.Administrator", "Administrator")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.BusinessEntities.Reservation", b =>
                {
                    ...
                    b.HasOne("Domain.BusinessEntities.ReservationState", "ActualState")
                        .WithMany()
