...
namespace MinTur.DataAccess.Migrations
{
    ...
    [Migration("20200924015345_ManyToManyCategoryTouristPoint")]
    partial class ManyToManyCategoryTouristPoint
    {
            ...
            modelBuilder.Entity("Domain.BusinessEntities.TouristPointCategory", b =>
                {
                    ...
                    b.Property<int>("TourisPointId")
                        .HasColumnType("int");

                    b.HasKey("CategoryId", "TourisPointId");

                    b.HasIndex("TourisPointId");
